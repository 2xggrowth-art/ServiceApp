-- ============================================================
-- BCH Service Management - Multi-select Services & Parts at Check-in
-- ============================================================
-- Adds services (JSONB array) and checkin_parts (JSONB array) columns
-- to jobs table. These store the multi-select choices made at check-in.
-- ============================================================

-- Add new columns
ALTER TABLE public.jobs
  ADD COLUMN IF NOT EXISTS services JSONB DEFAULT '[]'::JSONB,
  ADD COLUMN IF NOT EXISTS checkin_parts JSONB DEFAULT '[]'::JSONB;

-- Update app_create_job to accept services and checkin_parts
...
BEGIN
  ...
  INSERT INTO public.jobs (
    ...
    p_services, p_checkin_parts
  )
  RETURNING *;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;

-- Update app_update_job to handle services and checkin_parts
