-- ============================================================
-- BCH Service Management - Allow Mechanic Job Takeover
-- ============================================================
-- Problem: app_update_job blocks mechanics from updating jobs
-- assigned to OTHER mechanics (line: "mechanic can only update own jobs").
-- This prevents the takeover feature where a mechanic reassigns
-- another mechanic's job to themselves when that mechanic is on break.
--
-- Fix: Allow mechanics to update another mechanic's job ONLY when
-- they are reassigning it to themselves (mechanic_id = p_caller_id).
-- ============================================================
